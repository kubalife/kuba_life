...
while {true} do 
{		
	CONTROL(6025,6026) ctrlSetStructuredText parseText format ["<t font='RobotoCondensed' align='center'>%1:%2<br/>%3.%4.%5</t>",life_zeit select 0,life_zeit select 1,life_zeit select 2,life_zeit select 3,life_zeit select 4];
	sleep 5;
