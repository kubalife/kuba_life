...
_strafliste = straftat GVAR [life_computergesucht,[]];  // hole den bericht aus diesem array
_display = findDisplay 6000;

_valueindex = lbValue[6012,(lbCurSel 6012)]; // das ist der value um welchen bericht es sich handeln soll
_bericht = "";
_officer = "";
