...
if((_vehicle isKindOf "Car") && (currentWeapon player) == "Radar_Gun") then
{
	switch (true) do
	{
		case ((_speed < 30)) :
		{
			hint parseText format ["<t color='#ffffff'><t size='2'><t align='center'>" +(localize "STR_Cop_Radar")+ "<br/><t color='#00FF09'><t align='center'><t size='1'>" +(localize "STR_Cop_VehSpeed"),round  _speed];
		};
