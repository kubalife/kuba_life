...
private["_robber","_shop","_kassa","_ui","_progress","_pgText","_cP","_rip","_Pos","_rndmrk","_mrkstring","_alrdyrobbed"];
...
if(_alrdyrobbed)exitWith {hint "Ich werde gerade ausgeraubt!";};
