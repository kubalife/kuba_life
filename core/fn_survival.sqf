    ...
    else
    {
        ...
        switch (life_hunger) do {
            case 30: {hint localize "STR_NOTF_EatMSG_1";
				player say3D "hunger";
				titleText["Etwas kleines zu Essen wäre nicht verkehrt...","PLAIN"];
			};
            case 20: {hint localize "STR_NOTF_EatMSG_2";
				player say3D "hunger";
				titleText["Langsam bekomme ich Hunger......","PLAIN"];
			};
            case 10: {
                hint localize "STR_NOTF_EatMSG_3";
				player say3D "hunger";
				titleText["Gleich fall ich vor Hunger in Ohnmacht...","PLAIN"];
    ...
    else
    {
        ...
        switch (life_thirst) do  {
            case 30: {hint localize "STR_NOTF_DrinkMSG_1";
				player say3D "hunger";
				titleText["Ein Schluck zu Trinken wäre nicht verkehrt...","PLAIN"];
			};
            case 20: {
                hint localize "STR_NOTF_DrinkMSG_2";
				player say3D "hunger";
				titleText["Ein Glas Wasser...Das wär's jetzt...","PLAIN"];
                if (LIFE_SETTINGS(getNumber,"enable_fatigue") isEqualTo 1) then {player setFatigue 1;};
            };
            case 10: {
                hint localize "STR_NOTF_DrinkMSG_3";
				player say3D "hunger";
				titleText["Wenn ich gleich nicht trinke kipp ich um...","PLAIN"];
                if (LIFE_SETTINGS(getNumber,"enable_fatigue") isEqualTo 1) then {player setFatigue 1;};
            };
        };
    };
