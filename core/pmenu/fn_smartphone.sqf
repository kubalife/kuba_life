...
_cMessageList = _display displayCtrl 88882;ctrlShow[1201,false];ctrlShow[2401,false];
...
switch(_type) do{
	case 0:{
		...
		} forEach playableUnits;[getPlayerUID player, player] remoteExecCall ["TON_fnc_msgRequest",2];
		ctrlShow[1201,false];
		ctrlShow[2401,false];
	};
