class smartphone {
	...
	class controlsBackground {
		...
		class Life_RscPicture_1200: Life_RscPictureKeepAspect{
			idc = 1200;text = "icons\Background.paa";
			x = -0.0625;
			y = -0.3;
			w = 1.1375;
	...
	class controls {
		class Life_RscButtonInvisible_2400: Life_RscButtonInvisible{
			idc = 2400;
			onButtonClick = "createDialog ""Life_key_management"";";tooltip = "Schlüsselverwaltung";
			x = 0.3375;
			y = 0.14;
			w = 0.0625;
			h = 0.1;
	...
	class Life_RscButtonInvisible_2401: Life_RscButtonInvisible{
		...
		tooltip = "Erstelle deine Gang und verwalte sie";
		x = 0.425;
		y = 0.14;
		w = 0.0625;
		h = 0.1;
	...
	class Life_RscButtonInvisible_2402: Life_RscButtonInvisible{
		...
		tooltip = "Polizei Terror Warnung";
		x = 0.525;
		y = 0.14;
		w = 0.0625;
		h = 0.1;
	...
	class Life_RscButtonInvisible_2407: Life_RscButtonInvisible{
		...
		tooltip = "Überprüfe deine Lizenzen";
		x = 0.625;
		y = 0.28;
		w = 0.0625;
		h = 0.1;
	...
	class Life_RscButtonInvisible_2408: Life_RscButtonInvisible{
		idc = 2408;
		onButtonClick = "if(side player == west) then {[] call life_fnc_wantedMenu;}";
	...
	class Life_RscButtonInvisible_2416: Life_RscButtonInvisible{
		...
		tooltip = "Nachrichtenservice Kuba";
		x = 0.625;
		y = 0.8;
		w = 0.0625;
		h = 0.1;
	...
	class RscButtonMenu_CallBackup: Life_RscButtonInvisible{
		...
		tooltip = "Sende Notsignal an diesem Standort";
		x = 0.525;
		y = 0.54;
		w = 0.0625;
		h = 0.08;
