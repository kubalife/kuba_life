...
/*
	player createDiaryRecord ["credits",
		[
			"Code Red Gaming",
				"
					All credits go towards the Arma3.Info Development team.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["changelog",
		[
			"Altis Life Change Log",
				"
					The official changelog can be found on www.arma3.info<br/><br/>

					If you want to be up to date on everything<br/>
	...
	player createDiaryRecord["changelog",
		[
			"Server Change Log",
				"
					Changelog on www.arma3.info<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				The list is available at www.arma3.info<br/><br/>
				"
		]
	];
